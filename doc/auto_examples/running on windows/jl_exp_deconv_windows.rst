.. note::
    ...
    Click :ref:`here <sphx_glr_download_auto_examples_running on windows_jl_exp_deconv_windows.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_running on windows_jl_exp_deconv_windows.py:
...
.. _sphx_glr_download_auto_examples_running on windows_jl_exp_deconv_windows.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Jupyter notebook: jl_exp_deconv_windows.ipynb <jl_exp_deconv_windows.ipynb>`
